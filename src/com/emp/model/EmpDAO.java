	...
	static {
		try {
	        ...
	        private static final String INSERT_STMT =
			  "INSERT INTO EMPLOYEE (emp_id, emp_name, emp_acc, emp_pwd, emp_pic, "
			...
			private static final String UPDATE =
			  "UPDATE EMPLOYEE set emp_name=?, emp_acc=?, emp_pwd=?, emp_pic=?, emp_phone=?, emp_email=?,emp_city=?,"
			...
			try {
				...
				pstmt.setString(7, empVO.getEmp_city());
				pstmt.setString(8, empVO.getEmp_town());
				pstmt.setString(9, empVO.getEmp_address());
				pstmt.setString(10, empVO.getEmp_status());
				pstmt.setString(11, empVO.getTitle_no());
				pstmt.setString(12, empVO.getDept_no());
			...
			public void update(EmpVO empVO) {
				...
				try {
					...
					pstmt.setString(11, empVO.getTitle_no());
					pstmt.setString(12, empVO.getDept_no());
					pstmt.setString(13, empVO.getEmp_id());
