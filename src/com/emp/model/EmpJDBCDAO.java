...
public class EmpJDBCDAO implements EmpDAO_interface{
	...
	private static final String INSERT_STMT =
	  "INSERT INTO EMPLOYEE (emp_id, emp_name, emp_acc, emp_pwd, emp_email, title_no, dept_no)"
	...
	private static final String GET_ONE_STMT =
	  "SELECT emp_id, emp_name, emp_acc, emp_pwd, emp_pic, emp_phone, emp_email, emp_city, emp_town,"  
	  + "emp_address, emp_status, emp_date, title_no, dept_no FROM EMPLOYEE where emp_id=?";
	
	private static final String UPDATE =
	  "UPDATE EMPLOYEE set emp_name=?, emp_acc=?, emp_pwd=?, emp_email=?, title_no=?, dept_no=? where emp_id=?";
	...
	private static final String GetOneByAcc =
	    "SELECT * FROM EMPLOYEE where emp_acc=? and emp_pwd=?";
	...
	public EmpVO insert(EmpVO empVO) {
		...
		try {
			...
			pstmt.setString(3, empVO.getEmp_pwd());
			pstmt.setString(4, empVO.getEmp_email());
			pstmt.setString(5, empVO.getTitle_no());
			pstmt.setString(6, empVO.getDept_no());
	...
	public EmpVO login(String emp_acc, String emp_pwd) {
		...
		try {
			...
			Class.forName(driver);
			con = DriverManager.getConnection(url, userid, passwd);
			pstmt = con.prepareStatement(GetOneByAcc);
...
//            System.out.print(Emp.getEmp_acc() + ",");
...
//		dao.insertWithAuths(empVO , testList);
		...
		EmpVO empVO4 = dao.login("emp00001", "123456");
		System.out.print(empVO4.getEmp_id() + ",");
		System.out.print(empVO4.getEmp_name() + ",");
		System.out.print(empVO4.getEmp_acc() + ",");
