	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("update".equals(action)) {//來自update_emp.jsp的請求
			...
			try {
				...
				//開始員工修改資料
				EmpService empSvc = new EmpService();
				empVO = empSvc.updateEmp(emp_id, emp_name, emp_acc, emp_pwd, emp_pic, emp_phone, emp_email, emp_city, emp_town, 
		   ...
		   if ("insert".equals(action)) {//來自addEmp.jsp的請求
			...
			try {
				...
				//開始新增員工資料
				EmpService empSvc = new EmpService();
				EmpVO newEmp = empSvc.addEmp(emp_name, emp_acc, emp_pwd, emp_pic,
