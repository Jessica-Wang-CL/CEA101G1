...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/selectPage.css" />
</head>
<body>
 <div class="container">
            <div class="card">
                ...
                <div class="right">
                    <img id="company" src="${pageContext.request.contextPath}/images/company.png" width="150" />
                    <div>
                ...
                <div class="right">
                    ...
                    <img src="${pageContext.request.contextPath}/images/employee.png" width="150" />
                    </a>
                    <div>
