...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.2.1/css/bootstrap.min.css">
 ...
 <link rel="stylesheet" href="${pageContext.request.contextPath}/css/listAllEmp.css" />
 <link rel="stylesheet" href="${pageContext.request.contextPath}/css/Searching.css" /> 
 <style>
 </style>
</head>
...
<c:if test="${not empty errorMsgs}">
 ...
 <a href='<%=request.getContextPath()%>/backend/emp/protected/addEmp.jsp'>
    <img src="${pageContext.request.contextPath}/images/Add.png" width="50" />
 </a>
	<table>
